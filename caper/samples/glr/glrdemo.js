            ...
            if (0 < data.length) {
                ...
                parser.draw({
                    drawVertex : function(i, t, x, y) {
                        window.cy.add({ group: "nodes", data: { id: 'vertex'+i, name: t, faveColor: '#D88' }, position: {x: 100 + x * 100, y: 100 + y * 50}, locked: true });
                    },
                    ...
                    drawNode : function(i, x, y, t) {
                        window.cy.add({ group: "nodes", data: { id: 'node'+i, name: t, faveColor: '#88D' }, position: {x: 100 + x * 100, y: 400 + y * 50}, locked: true });
                    },
